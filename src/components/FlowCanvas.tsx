...
import ReactFlow, {
  ...
  Connection,
  Edge,
  EdgeChange, // Keep EdgeChange here
  Node,
  NodeChange,
  useReactFlow,
  ReactFlowProvider,
...
import LLMOutputNode from './nodes/LLMOutputNode'; // Import LLMOutputNode
...
const nodeTypes = {
  ...
  llmOutputNode: LLMOutputNode, // Add LLMOutputNode
};

interface FlowCanvasProps {
  isDarkMode: boolean;
  setIsDarkMode: (isDarkMode: boolean) => void; // This prop is already here
...
function FlowCanvasInner({ isDarkMode, setIsDarkMode, onNavigate, canvasId }: FlowCanvasProps) {
  // Remove the internal isDarkMode state, as it's now controlled by App.tsx
  // const [isDarkMode, setIsDarkMode] = useState(true); // This line should be removed or commented out
  ...
  return (
    ...
    >
      ...
      <NeuralScaffold
        ...
        viewport={viewport}
        patternType="grid" // Set default pattern to grid
      />
      ...
      <ReactFlow
        ...
        className={`${isDarkMode ? 'bg-black' : 'bg-light-peach-yellow'} relative z-10`}
      ...
      >
        ...
        <div className="absolute bottom-6 right-6 z-20">
          ...
          `}>
            ...
            <button
              onClick={() => {
                console.log('Toggling dark mode. Current isDarkMode:', isDarkMode);
